...
class Tag
{
     ...
     * HTML document title
     */
    static protected $_documentTitle;

    static protected $_documentTitleSeparator;
    ...
    static protected $_urlService;

    static protected $_dispatcherService;

    static protected $_escaperService;
